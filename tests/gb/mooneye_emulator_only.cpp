...
int main() {
  ...
  std::printf("NativeCore GB Test: mooneye/emulator-only\n\n");
  nativecore::testing::runTestDirectory(
      base + "/mooneye-test-suite/emulator-only", "mooneye/emulator-only",
      ".gb", gb_tests::mooneyeBlacklist(), gb_tests::makeMooneyeRunner(), total,
